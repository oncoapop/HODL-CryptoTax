...
if st.sidebar.button("Re-run Ingestion & Tax Computation", help="Re-reads all transaction CSVs and completely recalculates the tax database."):
    with st.spinner("Rebuilding database and recalculating taxes..."):
